...
trait Datacenter
{
     ...
     */
    public function getListOfDatacenters($query = [])
    {
        return $this->request('GET', 'datacenter', [], $query);
    }

    public function getDatacenter($name) {
        return $this->request('GET', 'datacenter/' . $name, []);
    }
